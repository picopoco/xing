...
// t8428 증시주변자금추이
type S질의값_증시주변자금추이_t8428 struct {
	*lib.S질의값_기본형
...
func New질의값_증시주변자금추이() *S질의값_증시주변자금추이_t8428 {
...
func NewT8428InBlock(질의값 *S질의값_증시주변자금추이_t8428) (g *T8428InBlock) {
	시장구분_문자열 := ""
	switch 질의값.M시장구분 {
	case lib.P시장구분_코스피:
		시장구분_문자열 = "001"
