...
const (
	P호가_유형_보통      T호가_유형_t0425 = 00
	P호가_유형_시장가     T호가_유형_t0425 = 03
	P호가_유형_조건부_지정가 T호가_유형_t0425 = 05
	P호가_유형_최유리_지정가 T호가_유형_t0425 = 06
	P호가_유형_최우선_지정가 T호가_유형_t0425 = 07
	P호가_유형_보통_IOC  T호가_유형_t0425 = 10
	P호가_유형_시장가_IOC T호가_유형_t0425 = 13
	P호가_유형_최유리_IOC T호가_유형_t0425 = 16
	P호가_유형_보통_FOK  T호가_유형_t0425 = 20
	P호가_유형_시장가_FOK T호가_유형_t0425 = 23
	P호가_유형_최유리_FOK T호가_유형_t0425 = 26
	P호가_유형_장전_시간외  T호가_유형_t0425 = 61
	P호가_유형_장후_시간외  T호가_유형_t0425 = 81
	P호가_유형_시간외_단일가 T호가_유형_t0425 = 82
)
...
func (p T호가_유형_t0425) String() string {
	...
	case P호가_유형_시간외_단일가:
		return "시간외 단일가"
	default:
		return lib.F2문자열("예상하지 못한 호가 유형 값 : '%v'", int(p))
	}
}
...
func (p T주문_구분_t0425) String() string {
	...
	case P주문_구분_신용:
		return "신용"
	default:
		return lib.F2문자열("예상하지 못한 주문 구분값  : '%s'", string(p))
	}
}
...
const (
	...
	P자료형_S질의값_투자경고_조회_t1405       = "S질의값_투자경고_조회_t1405"
	P자료형_S질의값_재무순위_t3341          = "S질의값_재무순위_t3341"
	P자료형_S질의값_현물_차트_틱_t8411       = "S질의값_현물_차트_틱_t8411"
	P자료형_S질의값_현물_차트_분_t8412       = "S질의값_현물_차트_분_t8412"
	P자료형_S질의값_현물_차트_일주월_t8413     = "S질의값_현물_차트_일주월_t8413"
	P자료형_S질의값_증시주변자금추이_t8428      = "S질의값_증시주변자금추이_t8428"
	...
	P자료형_S현물_기간별_조회_응답              = "S현물_기간별_조회_응답_t1305"
	P자료형_S현물_기간별_조회_응답_헤더_t1305     = "S현물_기간별_조회_응답_헤더_t1305"
	P자료형_S현물_기간별_조회_응답_반복값_t1305    = "S현물_기간별_조회_응답_반복값_t1305"
	P자료형_S현물_기간별_조회_응답_반복값_모음_t1305 = "S현물_기간별_조회_응답_반복값_모음_t1305"
	...
	P자료형_S현물_차트_일주월_응답              = "S현물_차트_일주월_응답"
	P자료형_S현물_차트_일주월_응답_헤더           = "S현물_차트_일주월_응답_헤더"
	P자료형_S현물_차트_일주월_응답_반복값          = "S현물_차트_일주월_응답_반복값"
	P자료형_S현물_차트_일주월_응답_반복값_모음       = "S현물_차트_일주월_응답_반복값_모음"
