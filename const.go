...
const (
	// 구현된 TR코드
	TR현물_정상주문        = "CSPAT00600"
	TR현물_정정주문        = "CSPAT00700"
	TR현물_취소주문        = "CSPAT00800"
...
func (p T호가유형) String() string {
	...
	panic(lib.F2문자열("예상하지 못한 호가유형. '%v'", p))
...
func (p T신용거래_구분) String() string {
	...
	panic(lib.F2문자열("예상하지 못한 신용거래 구분. '%v'", p))
...
const (
	P자료형_S질의값_정상주문          = "S질의값_정상주문"
	P자료형_S질의값_정정주문          = "S질의값_정정주문"
	P자료형_S질의값_취소주문          = "S질의값_취소주문"
	...
	P자료형_S호출_인수_기본형 = "S호출_인수_기본형"
	P자료형_S호출_인수_정수값 = "S호출_인수_정수값"
	P자료형_S호출_인수_문자열 = "S호출_인수_문자열"
	P자료형_S호출_인수_질의 = "S호출_인수_질의"
	P자료형_S호출_인수_실시간_정보 = "S호출_인수_실시간_정보"
	P자료형_S호출_인수_압축_해제 = "S호출_인수_압축_해제"
	...
	P자료형_S현물_정상주문_응답 = "S현물_정상주문_응답"
	P자료형_S현물_정상주문_응답1 = "S현물_정상주문_응답1"
	P자료형_S현물_정상주문_응답2 = "S현물_정상주문_응답2"
	P자료형_S현물_정정주문_응답 = "S현물_정정주문_응답"
	P자료형_S현물_정정주문_응답1 = "S현물_정정주문_응답1"
	P자료형_S현물_정정주문_응답2 = "S현물_정정주문_응답2"
	P자료형_S현물_취소주문_응답 = "S현물_취소주문_응답"
	P자료형_S현물_취소주문_응답1 = "S현물_취소주문_응답1"
	P자료형_S현물_취소주문_응답2 = "S현물_취소주문_응답2"
	...
	P자료형_S주식종목조회_응답_반복값 = "S현물_종목조회_응답_반복값"
	P자료형_S주식종목조회_응답_반복값_모음 = "S현물_종목조회_응답_반복값_모음"
)
