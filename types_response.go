...
func (s *S현물_차트_틱_응답_반복값) G수정구분_단일값() (단일값 uint32) {
	for _, 수정구분 := range s.M수정구분_모음 {
		단일값 += 수정구분.G정수값()
	}
...
func (s *S현물_차트_분_응답_반복값) G수정구분_단일값() (단일값 uint32) {
	for _, 수정구분 := range s.M수정구분_모음 {
		단일값 += 수정구분.G정수값()
	}
...
func (s *S현물_차트_일주월_응답_반복값) G수정구분_단일값() (단일값 uint32) {
	for _, 수정구분 := range s.M수정구분_모음 {
		단일값 += 수정구분.G정수값()
	}
