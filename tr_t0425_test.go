...
func TestT0425_체결_미체결_확인(t *testing.T) {
	t.Parallel()
	...
	값_모음, 에러 := TR_t0425_현물_체결_미체결_조회(계좌번호, 비밀번호, 종목코드, 체결_구분, 매도_매수_구분)
	lib.F테스트_에러없음(t, 에러)
	...
	for _, 값 := range 값_모음 {
		...
		lib.F테스트_같음(t, 값.M호가_유형, xt.P호가_유형_보통, xt.P호가_유형_시장가, xt.P호가_유형_조건부_지정가,
			xt.P호가_유형_최유리_지정가, xt.P호가_유형_최우선_지정가, xt.P호가_유형_보통_IOC, xt.P호가_유형_시장가_IOC,
			xt.P호가_유형_최유리_IOC, xt.P호가_유형_보통_FOK, xt.P호가_유형_시장가_FOK, xt.P호가_유형_최유리_FOK,
			xt.P호가_유형_장전_시간외, xt.P호가_유형_장후_시간외, xt.P호가_유형_시간외_단일가)
		lib.F테스트_참임(t, 값.M현재가 > 0)

		// 임시로 건너뜀. 게시판 질문 및 답변 대기.
		lib.F테스트_같음(t, 값.M주문_구분, xt.P주문구분_없음, xt.P주문구분_현금매도, xt.P주문구분_현금매수,
			xt.P주문구분_신용매도, xt.P주문구분_신용매수, xt.P주문구분_저축매도, xt.P주문구분_저축매수,
			xt.P주문구분_상품매도_대차, xt.P주문구분_상품매도, xt.P주문구분_상품매수, xt.P주문구분_선물대용매도_일반,
			xt.P주문구분_선물대용매도_반대, xt.P주문구분_현금매도_프, xt.P주문구분_현금매수_프,
			xt.P주문구분_현금매수_유가, xt.P주문구분_현금매수_정리, xt.P주문구분_상품매도_대차_프,
			xt.P주문구분_상품매도_프, xt.P주문구분_상품매수_프)
