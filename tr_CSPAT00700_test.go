...
func TestS질의값_정정_주문(t *testing.T) {
	_, ok := interface{}(new(S질의값_정정_주문_CSPAT00700)).(lib.I질의값)
	lib.F테스트_참임(t, ok)
}
...
func TestCSPAT00700현물_정정_주문(t *testing.T) {
	...
	질의값_정정주문.M구분 = TR주문
	질의값_정정주문.M코드 = TR현물_정정_주문_CSPAT00700
	...
	질의값_취소주문.M구분 = TR주문
	질의값_취소주문.M코드 = TR현물_취소_주문_CSPAT00800
	...
	for {
		...
		case RT현물_주문_거부_SC4:
			...
			t.FailNow()
		case RT현물_주문_체결_SC1, RT현물_주문_정정_SC2:
