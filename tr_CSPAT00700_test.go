...
func TestCSPAT00700현물_정정주문(t *testing.T) {
	...
	// 주문 접수 혹은 체결 확인
	for {
		실시간_정보, ok := 바이트_변환_모음.G해석값_단순형(0).(*S현물_주문_응답_실시간_정보)
		...
		case RT현물_주문_거부:
			...
			t.FailNow()
		case RT현물_주문_체결, RT현물_주문_정정, RT현물_주문_취소:
	...
	for i := 0; i < 반복_횟수; i++ {
		...
		정정_주문_증권사_접수, 정정_주문_거래소_접수 := false, false
