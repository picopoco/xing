...
func New현물_시세조회_응답(b []byte) (s *S현물_시세조회_응답, 에러 error) {
	...
	s.PBRX = lib.F2실수_소숫점_추가_단순형(g.Pbrx, 2)
	...
	s.M매도비율_모음[0] = lib.F2실수_소숫점_추가_단순형(g.Ddiff1, 2)
	s.M매수비율_모음[0] = lib.F2실수_소숫점_추가_단순형(g.Sdiff1, 2)
	...
	s.M매도비율_모음[1] = lib.F2실수_소숫점_추가_단순형(g.Ddiff2, 2)
	s.M매수비율_모음[1] = lib.F2실수_소숫점_추가_단순형(g.Sdiff2, 2)
	...
	s.M매도비율_모음[2] = lib.F2실수_소숫점_추가_단순형(g.Ddiff3, 2)
	s.M매수비율_모음[2] = lib.F2실수_소숫점_추가_단순형(g.Sdiff3, 2)
	...
	s.M매도비율_모음[3] = lib.F2실수_소숫점_추가_단순형(g.Ddiff4, 2)
	s.M매수비율_모음[3] = lib.F2실수_소숫점_추가_단순형(g.Sdiff4, 2)
	...
	s.M매도비율_모음[4] = lib.F2실수_소숫점_추가_단순형(g.Ddiff5, 2)
	s.M매수비율_모음[4] = lib.F2실수_소숫점_추가_단순형(g.Sdiff5, 2)
	s.M외국계_매도_합계수량 = lib.F2정수64_단순형(g.Fwdvl)
	s.M외국계_매도_직전대비 = lib.F2정수64_단순형(g.Ftradmdcha)
	s.M외국계_매도_비율 = lib.F2실수_소숫점_추가_단순형(g.Ftradmddiff, 2)
	s.M외국계_매수_합계수량 = lib.F2정수64_단순형(g.Fwsvl)
	s.M외국계_매수_직전대비 = lib.F2정수64_단순형(g.Ftradmscha)
	s.M외국계_매수_비율 = lib.F2실수_소숫점_추가_단순형(g.Ftradmsdiff, 2)
	...
	s.M전년대비매출액 = lib.F2실수_소숫점_추가_단순형(g.Salert, 2)
	s.M전년대비영업이익 = lib.F2실수_소숫점_추가_단순형(g.Opert, 2)
	s.M전년대비경상이익 = lib.F2실수_소숫점_추가_단순형(g.Ordrt, 2)
	s.M전년대비순이익 = lib.F2실수_소숫점_추가_단순형(g.Netrt, 2)
	s.M전년대비EPS = lib.F2실수_소숫점_추가_단순형(g.Epsrt, 2)
