...
func init() {
	...
	// 밤 12시, 오전 7시에 접속이 끊기는 듯.

	//TR현물_호가_조회 = "t1101"	// HTS 1101 화면,  DevCenter 소숫점 비교 확인 완료.
	//TR현물_시세_조회 = "t1102"	// HTS 1101 화면,  DevCenter 소숫점 비교 확인 완료.
	//TR현물_기간별_조회      = "t1305"	// HTS 1305 화면,  DevCenter 소숫점 비교 확인 완료.
	//TR현물_당일_전일_분틱_조회 = "t1310"	// HTS 1310 화면,  DevCenter 소숫점 비교 확인 완료.
	//TR_ETF_시간별_추이    = "t1902"	// HTS 1902 화면,  DevCenter 소숫점 비교 확인 완료.
	//TR기업정보_요약        = "t3320"	// HTS 3301, 3302 화면 비교 확인 완료. (CPS,SPS, EBITDAS 확인 불가)
	//TR재무순위_종합        = "t3341"	// HTS 3303 화면,  DevCenter 소숫점 비교 확인 완료.
	//TR현물_차트_틱        = "t8411"	// HTS 4001 화면,  DevCenter 소숫점 비교 확인 완료.
	//TR현물_차트_분        = "t8412"	// HTS 4001 화면,  DevCenter 소숫점 비교 확인 완료.
	//TR현물_차트_일주월      = "t8413"		// HTS 1305 화면, DevCenter 소숫점 비교 확인 완료.
	//TR증시_주변_자금_추이    = "t8428"	// HTS 1503 화면, DevCenter 소숫점 비교 확인 완료.
	//TR현물_종목_조회       = "t8436"	// 종목 정보 대조 비교 완료.

	메모 := `
- t1310 체결강도 데이터 DB저장할 것.
- 관리 종목 조회 기능 구현할 것. (t1404, t1405)
- 체결 확인 기능 구현할 것. (t0424, t0425)
...
- TR 결과값을 출력해서 HTS와 대조 비교해 볼 것. ("CSPAT00600", "CSPAT00700", "CSPAT00800", 실시간 정보들)
`
	lib.F메모(메모)
}
...
func tr동작_확인(ch완료 chan lib.T신호) {
	...
	if len(tr코드별_초당_전송_제한) == 0 {
		tr코드별_초당_전송_제한[TR시간_조회] = lib.New전송_권한(TR시간_조회, 5, lib.P1초)
	}
...
func f초기화_TR전송_제한() (에러 error) {
	...
	응답 := F질의(lib.New질의값_문자열_모음(TR코드별_전송_제한, "", TR코드_모음), lib.P5초)
	lib.F확인(응답.G에러())

	전송_제한_정보_모음 := new(TR코드별_전송_제한_정보_모음)
