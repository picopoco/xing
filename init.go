...
func init() {
	...
	lib.F메모("CPU 점유율이 너무 높다. 프로파일링 해서 병목 지점을 제거할 것.")
	lib.F메모("재무정보 정확성을 위해서 교차검증이 필요하다.")
	lib.F메모("관리 종목 조회 기능 구현할 것. (t1404, t1405)")
	lib.F메모("체결 확인 기능 구현할 것. (t0425)")
	lib.F메모("계좌 조회 기능 구현할 것. (CDPCQ04700, CSPAQ12200,CSPAQ12300, CSPAQ13700, FOCCQ33600)")
	lib.F메모("업종별 조회 기능. (t8424, t4203, t1514, t8419, t8424)")
	lib.F메모("테마별 조회 기능. (t8425, t1531)")
	lib.F메모("선물 가격 정보 수집 기능 구현할 것. (t8415, t8416, t9943)")
	lib.F메모("뉴스 및 공시 정보. (t3102,t3202)")
	lib.F메모("해외 지수 (o3123, o3121, t3518, t3521)") // o31xx는 해외선물 계좌 내지 모의투자 있어야 보임.
	lib.F메모("접속이 끊기거나, 로그아웃된 경우 재접속 하는 기능 구현할 것.")
