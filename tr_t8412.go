...
func F현물_차트_30초_t8412(종목코드 string, 시작일자, 종료일자 time.Time, 추가_인수_모음 ...interface{}) (응답값_모음 []*S현물_차트_분_응답_반복값, 에러 error) {
...
// t8412 현물 차트 분
type S질의값_현물_차트_분_t8412 struct {
	*lib.S질의값_단일_종목
	M단위     int // n분
...
func New질의값_현물_차트_분() *S질의값_현물_차트_분_t8412 {
...
func NewT8412InBlock(질의값 *S질의값_현물_차트_분_t8412) (g *T8412InBlock) {
	g = new(T8412InBlock)
