...
// t8411 현물 차트 틱
type S질의값_현물_차트_틱_t8411 struct {
	*lib.S질의값_단일_종목
	M단위     int // n틱
...
func (s *S현물_차트_틱_응답_반복값) G수정구분_모음() ([]T수정구분, error) {
	return f2수정구분_모음(s.M수정구분)
}

// t8411 현물 차트 틱 응답 반복값 모음
...
func New질의값_현물_차트_틱() *S질의값_현물_차트_틱_t8411 {
...
func NewT8411InBlock(질의값 *S질의값_현물_차트_틱_t8411) (g *T8411InBlock) {
	g = new(T8411InBlock)
