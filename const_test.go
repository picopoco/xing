...
func TestP자료형_문자열(t *testing.T) {
	...
	lib.F테스트_같음(t, P자료형_S질의값_정상_주문_CSPAT00600, f자료형_문자열(S질의값_정상_주문_CSPAT00600{}))
	lib.F테스트_같음(t, P자료형_S질의값_정정_주문_CSPAT00700, f자료형_문자열(S질의값_정정_주문_CSPAT00700{}))
	lib.F테스트_같음(t, P자료형_S질의값_취소_주문_CSPAT00800, f자료형_문자열(S질의값_취소_주문_CSPAT00800{}))
	lib.F테스트_같음(t, P자료형_S질의값_체결_미체결_조회_t0425, f자료형_문자열(S질의값_체결_미체결_조회_t0425{}))
	lib.F테스트_같음(t, P자료형_S질의값_현물_기간별_조회_t1305, f자료형_문자열(S질의값_현물_기간별_조회_t1305{}))
	lib.F테스트_같음(t, P자료형_S질의값_현물_전일당일_분틱_조회_t1310, f자료형_문자열(S질의값_현물_전일당일_분틱_조회_t1310{}))
	lib.F테스트_같음(t, P자료형_S질의값_관리종목_조회_t1404, f자료형_문자열(S질의값_관리종목_조회_t1404{}))
	lib.F테스트_같음(t, P자료형_S질의값_투자경고_조회_t1405, f자료형_문자열(S질의값_투자경고_조회_t1405{}))
	lib.F테스트_같음(t, P자료형_S질의값_재무순위_t3341, f자료형_문자열(S질의값_재무순위_t3341{}))
	lib.F테스트_같음(t, P자료형_S질의값_현물_차트_틱_t8411, f자료형_문자열(S질의값_현물_차트_틱_t8411{}))
	lib.F테스트_같음(t, P자료형_S질의값_현물_차트_분_t8412, f자료형_문자열(S질의값_현물_차트_분_t8412{}))
	lib.F테스트_같음(t, P자료형_S질의값_현물_차트_일주월_t8413, f자료형_문자열(S질의값_현물_차트_일주월_t8413{}))
	lib.F테스트_같음(t, P자료형_S질의값_증시주변자금추이_t8428, f자료형_문자열(S질의값_증시주변자금추이_t8428{}))
	...
	lib.F테스트_같음(t, P자료형_S현물_호가조회_응답, f자료형_문자열(S현물_호가_조회_응답{}))
	...
	lib.F테스트_같음(t, P자료형_S현물_기간별_조회_응답, f자료형_문자열(S현물_기간별_조회_응답_t1305{}))
	lib.F테스트_같음(t, P자료형_S현물_기간별_조회_응답_헤더_t1305, f자료형_문자열(S현물_기간별_조회_응답_헤더_t1305{}))
	lib.F테스트_같음(t, P자료형_S현물_기간별_조회_응답_반복값_t1305, f자료형_문자열(S현물_기간별_조회_응답_반복값_t1305{}))
	lib.F테스트_같음(t, P자료형_S현물_기간별_조회_응답_반복값_모음_t1305, f자료형_문자열(S현물_기간별_조회_응답_반복값_모음_t1305{}))
